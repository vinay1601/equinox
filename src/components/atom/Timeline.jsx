    ...
    <div className="space-y-1">
      {timelineData.map((group) => (
        <div key={group.date}>
          ...
          <div className="bg-white py-4 rounded-md border border-gray-300">
            <div className="space-y-1">
              {group.events.map((event, idx) => (
                <div key={idx} className="flex gap-4">
                  ...
                  <div className="relative px-4 border-l-2 border-gray-300">
                    ...
                    <p className="text-xs text-gray-500 ">
                      ...
                      <br />
                      <span className="flex font-medium justify-end pt-0.5">
                        -{event.by}
                      </span>
                    </p>
                  </div>
