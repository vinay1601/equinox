...
const Navbar = () => {
  return (
    <div>
      <Card className="w-full max-w-[calc(100%-5%)] mx-auto mt-4 !py-4 rounded-2xl border border-gray-300">
          ...
          <div className="flex flex-col md:flex-row md:justify-between md:items-start gap-4">
            <div className="space-y-1">
              ...
              <p className="text-sm text-gray-500">
                ...
                <span className="inline-block bg-blue-50 text-blue-500 font-semibold text-sm px-3.5 mx-3 py-1 rounded-xl">
                  POSTPAID
                </span>
              </p>
            </div>
            ...
            <div className="items-center gap-3 hidden md:flex">
              ...
              <Button
                size="sm"
                className="text-sm items-cener bg-blue-600 py-5"
              >
                <Plus className="size-3" /> Raise Query
              </Button>
            </div>
          </div>
